  ...
  return (
    ...
    >
      <Dialog.Panel className="bg-white p-5 rounded-xl grid justify-items-center gap-5 z-30">
        ...
        <p className="text-xl font-semibold flex text-orange-600">Rp. {data?.price}<p className="text-xs flex items-end">/pcs</p></p>
        <p className="text-orange-600 font-semibold text-xl">Total : Rp. {count * data?.price}</p>
        </div>
