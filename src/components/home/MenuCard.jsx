...
export default function MenuCard() {
  return (
    <div className="flex flex-col items-center shadow-lg justify-between min-w-80 max-w-96 rounded-lg overflow-hidden">
      ...
      <button className="py-1 px-3 font-bold rounded-xl mb-4 w-fit bg-primary-red shadow-xl text-white text-lg">
        Pesan Sekarang !
      </button>
    </div>
  );
