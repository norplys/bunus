...
export default function FavouriteMenu() {
  return (
    <section className="grid  gap-5 min-w-screen">
      <h1 className="xl:text-5xl font-bold  text-primary-red  rounded-2xl py-2 w-fit px-5 justify-self-center md:text-4xl text-2xl">
        Menu Favorit
      </h1>
      <div className="max-w-3xl md:text-center justify-self-center md:text-sm xl:text-base text-justify px-5 md:px-0">
      ...
      <div className="grid md:grid-cols-3 justify-items-center max-w-[1320px] justify-self-center gap-5 px-5 md:px-0">
        {array.map((each, i) => (
