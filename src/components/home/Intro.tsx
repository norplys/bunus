    ...
    <SlideIn>
      <div className="flex min-w-full items-center justify-center gap-52 py-8 ">
        <div className=" grid gap-2">
          ...
          <button className="py-2 px-4 font-bold rounded-xl mt-2 w-fit bg-primary-red shadow-xl text-white text-xl scale-95 hover:scale-100 duration-300 hover:shadow-2xl">
            Pesan Sekarang !
          </button>
        </div>
